<template>
    <div>
        <b-modal :id="modal_form_produto" size="lg" :header-bg-variant="headerBgVariant"
            :header-text-variant="headerTextVariant" no-close-on-backdrop hide-footer>
            <template v-slot:modal-header>
                <h5>{{ form.titulo }}</h5>
                <b-button style="border: 0" size="sm" variant="outline-light" @click="closeProduto()">
                    X
                </b-button>
            </template>
            <b-card class="mt-0 mb-3" header="Formulário de cadastro Produto">
                <slot name="conteudo">
                    <b-form>
                        <div class="row col-12 mt-2">
                            ...
                            <div class="col-md-7">
                                <label>Produto:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="produto" type="text" placeholder="Nome do Produto" v-model="form.produto"
                                    :class="{ 'fail-error': $v.form.produto.$error }" :title="form.produto"
                            ...
                            <div class="col-md-3">
                                <label>Qtd Unidade:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="unidade" type="text" v-model="form.unidade"
                                    :class="{ 'fail-error': $v.form.unidade.$error }" placeholder="Unidade"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-3">
                                <label>Código:</label>
                                <b-form-input id="id_categoria" type="number" v-model="form.id_categoria"
                                    :class="{ 'fail-error': $v.form.id_categoria.$error }" placeholder="Código"
                                    :title="form.id_categoria" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-9">
                                ...
                                <b-overlay :show="false" rounded="sm">
                                    <b-input-group>
                                        <b-form-input id="categoria" type="text" v-model="form.categoria"
                                            :class="{ 'fail-error': $v.form.categoria.$error }" placeholder="Categoria"
                                            disabled :title="form.categoria">
                                        </b-form-input>
                                        <b-input-group-append>
                                            <b-button @click="showSearchCategoria()" text="Button" variant="dark"
                                                :disabled="form.disabled" title="Pesquisar Categoria"><svg
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-3">
                                <label>Código:</label>
                                <b-form-input id="id_fornecedor" type="number" v-model="form.id_fornecedor"
                                    :class="{ 'fail-error': $v.form.id_fornecedor.$error }" placeholder="Código"
                                    :title="form.id_fornecedor" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-9">
                                <label>Fornecedor:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-overlay :show="false" rounded="sm">
                                    <b-input-group>
                                        <b-form-input id="fornecedor" type="text" v-model="form.fornecedor"
                                            :class="{ 'fail-error': $v.form.fornecedor.$error }" placeholder="Fornecedor"
                                            disabled :title="form.fornecedor">
                                        </b-form-input>
                                        <b-input-group-append>
                                            <b-button @click="showSearchFornecedor()" text="Button" variant="dark"
                                                :disabled="form.disabled" title="Pesquisar Fornecedor"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                    <path
                                                        d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                <label>Preço Custo:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="precoCusto" type="number" v-model="form.precoCusto"
                                    placeholder="Preço de Custo" :class="{ 'fail-error': $v.form.precoCusto.$error }"
                                    :title="form.precoCusto" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-4">
                                <label>Preço Venda:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="precoCusto" type="number" v-model="form.precoCusto"
                                    placeholder="Preço de Venda" :class="{ 'fail-error': $v.form.precoCusto.$error }"
                                    :title="form.precoCusto" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                                    {{ validationMsg($v.form.precoCusto) }}
                            ...
                            <div class="col-md-4">
                                <label>Custo Ult Compra:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="precoCusto" type="number" v-model="form.precoCusto"
                                    placeholder="Custo Ultima Compra" :class="{ 'fail-error': $v.form.precoCusto.$error }"
                                    :title="form.precoCusto" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                                    {{ validationMsg($v.form.precoCusto) }}
                        ...
                        <div class="row col-12 mt-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <b-form-input id="dataNasc" type="date" 
                                     :disabled="form.disabled">
                                </b-form-input>
                                <!-- <small style="font-size: 11px; color: red">
                        ...
                        <small class="mt-2" style="font-size: 12px">Campos com <b style="color: rgb(245, 153, 153)">*</b>
                            são
                            obrigatórios !</small>
                    </b-form>
                </slot>
                <slot name="botao">
                    <div class="d-flex justify-content-end">
                        <b-button class="btn btn-sm me-1" type="button" variant="dark" @click.prevent="closeProduto()">
                            Cancelar
                        </b-button>
        ...
        <b-modal :id="modal_search_categoria" size="xl" :header-bg-variant="headerBgVariant"
            :header-text-variant="headerTextVariant" no-close-on-backdrop hide-footer>
            <template v-slot:modal-header>
                <h5>Pesquisar Categoria</h5>
                <b-button style="border: 0" size="sm" variant="outline-light" @click="fecharModalSearchCategoria()">
                    X
                </b-button>
            </template>
            <b-container fluid>
                <HomeCategoria :functionCategorias="changeSearchCategoria"></HomeCategoria>
            </b-container>
            <b-container class="col-sm-12 col-md-12 mt-3" style="text-align: center;" footer>
                <b-button @click="fecharModalSearchCategoria()" type="button" id="" class="btn btn-dark btn-sm">Fechar
                    Pesquisa Categoria</b-button>
            </b-container>
        </b-modal>
        <b-modal :id="modal_search_fornecedor" size="xl" :header-bg-variant="headerBgVariant"
            :header-text-variant="headerTextVariant" no-close-on-backdrop hide-footer>
            <template v-slot:modal-header>
                <h5>Pesquisar Fornecedor</h5>
                <b-button style="border: 0" size="sm" variant="outline-light" @click="fecharModalSearchFornecedor()">
                    X
                </b-button>
            </template>
            <b-container fluid>
                <HomeFornecedor :functionFornecedor="changeSearchFornecedor"></HomeFornecedor>
            </b-container>
            <b-container class="col-sm-12 col-md-12 mt-3" style="text-align: center;" footer>
                <b-button @click="fecharModalSearchFornecedor()" type="button" id="" class="btn btn-dark btn-sm">Fechar
                    Pesquisa Fornecedor</b-button>
            </b-container>
        </b-modal>
    </div>
</template>
