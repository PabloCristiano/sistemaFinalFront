<template>
    <div>
        <b-modal :id="modal_form_servico" size="lg" :header-bg-variant="headerBgVariant"
                    ...
                    <b-form>
                        <div class="row col-12">
                            ...
                            <div class="col-md-10">
                                ...
                                <b-form-input id="servico" type="text" placeholder="Digite nome do Serviço"
                                    :class="{ 'fail-error': $v.form.servico.$error }" v-model="form.servico"
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                ...
                                <b-form-input id="tempo" type="number" placeholder="Tempo em Minutos"
                                    :class="{ 'fail-error': $v.form.tempo.$error }" v-model="form.tempo"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-4">
                                ...
                                <b-form-input id="valor" type="number" placeholder="R$ 0,00"
                                    :class="{ 'fail-error': $v.form.valor.$error }" v-model="form.valor"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-4">
                                ...
                                <b-form-input id="comissao" type="number" placeholder="%"
                                    :class="{ 'fail-error': $v.form.comissao.$error }" v-model="form.comissao"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-12">
                                ...
                                <b-form-textarea id="observacoes" v-model="form.observacoes"
                                    placeholder="Digite alguma Observação..." rows="3" max-rows="6"
                                    :title="form.observacoes" :disabled="form.disabled"></b-form-textarea>
                            </div>
                        </div>
                        <div>
