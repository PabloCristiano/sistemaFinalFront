...
const Agenda = () =>
  import(/* webpackChunkName: "Agenda" */ "@/components/agenda/Agenda");
const HomePais = () =>
  import(/* webpackChunkName: "Pais" */ "@/components/pais/HomePais");
const HomeEstado = () =>
  import(/* webpackChunkName: "Estado" */ "@/components/estado/HomeEstado");
const HomeCidade = () =>
  import(/* webpackChunkName: "Cidade" */ "@/components/cidade/HomeCidade");
const HomeFornecedor = () =>
  import(
    /* webpackChunkName: "Fornecedor" */ "@/components/fornecedores/HomeFornecedor"
  );
const HomeCliente = () =>
  import(
    /* webpackChunkName: "Fornecedor" */ "@/components/cliente/HomeCliente"
  );
const HomeCategorias = () =>
  import(
    /* webpackChunkName: "Fornecedor" */ "@/components/categorias/HomeCategorias"
  );
const HomeServico = () =>
  import(/* webpackChunkName: "Servico" */ "@/components/servico/HomeServico");
const HomeProfissional = () =>
  import(
    /* webpackChunkName: "Profissional" */ "@/components/profissional/HomeProfissional"
  );
const HomeProduto = () =>
  import(/* webpackChunkName: "Produto" */ "@/components/produto/HomeProduto");
const HomeFormaPagamento = () =>
  import(
    /* webpackChunkName: "FormaPagamento" */ "@/components/formaPagamento/HomeFormaPagamento"
  );
const HomeCondicaoPagamento = () =>
  import(
    /* webpackChunkName: "CondicaoPagamento" */ "@/components/condicaoPagamento/HomeCondicaoPagamento"
  );
const HomeCompra = () =>
  import(/* webpackChunkName: "Compra" */ "@/components/compra/HomeCompra");
const AdicionarCompra = () =>
  import(/* webpackChunkName: "Compra" */ "@/components/compra/Compra");
