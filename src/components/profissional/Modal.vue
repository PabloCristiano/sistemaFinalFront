        ...
        <slot name="conteudo">
          <b-form>
            ...
            <div class="row col-12 mt-2">
              ...
              <div class="col-md-4">
                <label
                  >Confirme a Senha:<b style="color: rgb(245, 153, 153)">
                    *</b
                  ></label
                >
                <b-form-input
                      ...
                      >
                        <template slot="table-row" slot-scope="props">
                          <span v-if="props.column.field === 'btn'">
                            <a
                              @click="excluirServico(props.row)"
                              size="sm"
        ...
        <slot name="botao">
          <div class="d-flex justify-content-end">
            <b-button
              ...
              type="button"
              variant="dark"
              @click.prevent="closeProfissional()"
            >
              Cancelar
            </b-button>
            <b-button
