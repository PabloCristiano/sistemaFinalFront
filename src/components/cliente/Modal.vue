<template>
    <div>
        <b-modal :id="modal_form_cliente" size="lg" :header-bg-variant="headerBgVariant"
            :header-text-variant="headerTextVariant" no-close-on-backdrop hide-footer>
            <template v-slot:modal-header>
                <h5>{{ form.titulo }}</h5>
                <b-button style="border: 0" size="sm" variant="outline-light" @click="closeCliente()">
                    X
                </b-button>
            </template>
            <b-card class="mt-0 mb-3" header="Formulário de cadastro Cliente">
                    ...
                    <b-form>
                        <div class="row col-12 mt-2">
                            ...
                            <div class="col-md-5">
                                ...
                                <b-form-input id="cliente" type="text" placeholder="Nome completo" v-model="form.cliente"
                                    :class="{ 'fail-error': $v.form.cliente.$error }" :title="form.cliente"
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                ...
                                <b-form-input id="form.cpf" type="text" v-model="form.cpf"
                                    :class="{ 'fail-error': $v.form.cpf.$error }" placeholder="Número CPF"
                                    v-mask="'###.###.###-##'" :maxlength="form.maxCpf" :title="form.cpf"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-4">
                                <label>RG:</label>
                                <b-form-input id="rg" type="text" v-model="form.rg" placeholder="Número do RG"
                                    v-mask="'#######-#'" :maxlength="form.maxRg" :title="form.rg" :disabled="form.disabled">
                                </b-form-input>
                            </div>
                            <div class="col-md-4">
                                <label>Data Nascimento:<b style="color: rgb(245, 153, 153)"> *</b></label>
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                ...
                                <b-form-input id="cep" type="text" v-model="form.cep" placeholder="_____-___"
                                    :class="{ 'fail-error': $v.form.cep.$error }" v-debounce:1000ms="cepDebounce"
                                    v-mask="'#####-###'" :maxlength="form.maxCep" :minlength="form.maxCep" :title="form.cep"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-8">
                                ...
                                <b-form-input id="logradouro" type="text" v-model="form.logradouro" placeholder="Logradouro"
                                    :class="{ 'fail-error': $v.form.logradouro.$error }" :title="form.logradouro"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-2">
                                ...
                                <b-form-input id="numero" type="number" v-model="form.numero" placeholder="Número"
                                    :class="{ 'fail-error': $v.form.numero.$error }" :title="form.numero"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-5">
                                ...
                                <b-form-input id="complemento" type="text" v-model="form.complemento"
                                    placeholder="Complemento" :title="form.complemento" :disabled="form.disabled">
                                </b-form-input>
                            </div>
                            <div class="col-md-5">
                                <label>Bairro:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="bairro" type="text" v-model="form.bairro" placeholder="Bairro"
                                    :class="{ 'fail-error': $v.form.bairro.$error }" :title="form.bairro"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                                ...
                                <b-overlay :show="isLoadingCidade" rounded="sm">
                                    <b-input-group>
                                        ...
                                        <b-input-group-append>
                                            <b-button @click="showSearchCidade()" text="Button" variant="dark"
                                                :disabled="form.disabled" title="Pesquisar Cidade"><svg
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-6">
                                ...
                                <b-form-input id="whatsapp" type="text" v-model="form.whatsapp"
                                    placeholder="(99) 99999-9999" v-mask="'(##) #####-####'" :maxlength="form.maxWhatsapp"
                                    :title="form.whatsapp" :disabled="form.disabled">
                                </b-form-input>
                            </div>
                            <div class="col-md-6">
                                <label>Telefone:<b style="color: rgb(245, 153, 153)"> *</b></label>
                                <b-form-input id="telefone" type="text" v-model="form.telefone"
                                    placeholder="(99) 99999-9999" v-mask="'(##) #####-####'"
                                    :class="{ 'fail-error': $v.form.telefone.$error }" :maxlength="form.maxTelefone"
                                    :title="form.telefone" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                ...
                                <b-form-input id="email" type="text" v-model="form.email" placeholder="Contato@contato.com"
                                    :class="{ 'fail-error': $v.form.email.$error }" :title="form.email"
                                    :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-4">
                                ...
                                <b-form-input id="senha" type="password" v-model="form.senha" placeholder="Digite uma senha"
                            ...
                            <div class="col-md-4">
                                <label>Confirma Senha:<b style="color: rgb(245, 153, 153)"> *</b></label>
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-4">
                                ...
                                <b-form-input id="id_condicaopg" type="number" v-model="form.id_condicaopg" value="487"
                                    :class="{ 'fail-error': $v.form.id_condicaopg.$error }" placeholder="Código"
                                    :title="form.id_condicaopg" :disabled="form.disabled">
                                </b-form-input>
                                <small style="font-size: 11px; color: red">
                            ...
                            <div class="col-md-8">
                                ...
                                <b-overlay :show="false" rounded="sm">
                                    <b-input-group>
                                        <b-form-input id="condicaopg" type="text" v-model="form.condicaopg"
                                            :value="30 / 60 / 90" :class="{ 'fail-error': $v.form.condicaopg.$error }"
                                            placeholder="Condição Pagamento" disabled :title="form.condicaopg">
                                        </b-form-input>
                                        <b-input-group-append>
                                            <b-button text="Button" variant="dark" :disabled="form.disabled"
                                                title="Pesquisar Condição de Pagamento"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                    <path
                                                        d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
                        ...
                        <div class="row col-12 mt-2">
                            <div class="col-md-12">
                                ...
                                <b-form-textarea id="observacao" v-model="form.observacao"
                                    placeholder="Digite alguma Observação..." rows="3" max-rows="6" :title="form.observacao"
                                    :disabled="form.disabled"></b-form-textarea>
                            </div>
                        </div>
                ...
                <slot name="botao">
                    <div class="d-flex justify-content-end">
                        <b-button class="btn btn-sm me-1" type="button" variant="dark" @click.prevent="closeCliente()">
                            Cancelar
                        </b-button>
