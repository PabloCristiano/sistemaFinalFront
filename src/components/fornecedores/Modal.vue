        ...
        <slot name="conteudo">
          <b-form>
            ...
            <div class="row col-12 mt-2">
              ...
              <div class="col-md-5">
                <label
                  >{{ texto }}<b style="color: rgb(245, 153, 153)"> *</b></label
                >
                <b-form-input
                  id="razaoSocial"
                  type="text"
                  :placeholder="placeholder"
                  :class="{ 'fail-error': $v.form.razaoSocial.$error }"
                  v-model="form.razaoSocial"
                  :title="form.razaoSocial"
              ...
              <div class="col-md-5" v-if="visibleDivTipoPessoa">
                <label
                  >Nome Fantasia:<b style="color: rgb(245, 153, 153)">
                    *</b
                  ></label
                >
                <b-form-input
                  ...
                  :class="{ 'fail-error': $v.form.nomefantasia.$error }"
                  placeholder="Digite Nome Fantasia"
                  :title="form.nomeFantasia"
                  :disabled="form.disabled"
                >
                </b-form-input>
                <small style="font-size: 11px; color: red">
            ...
            <div class="row col-12 mt-2" v-if="visibleDivTipoPessoa">
              <div class="col-md-6">
                ...
                <b-form-input
                  ...
                  type="text"
                  v-model="form.cnpj"
                  :class="{ 'fail-error': $v.form.cnpj.$error }"
                  placeholder="CNPJ"
                  v-mask="'##.###.###/####-##'"
                  :maxlength="form.maxCnpj"
                  :minlength="form.maxCnpj"
                  :title="form.cnpj"
                  :disabled="form.disabled"
                >
                </b-form-input>
            ...
            <div class="row col-12 mt-2">
              <div class="col-md-6">
                ...
                <b-form-input
                  id="form.pagSite"
                  type="text"
                  v-model="form.pagSite"
                  :class="{ 'fail-error': $v.form.pagSite.$error }"
              ...
              <div class="col-md-6">
                ...
                <b-form-input
                  ...
                  :title="form.contato"
                  :disabled="form.disabled"
                  :class="{ 'fail-error': $v.form.contato.$error }"
                >
                </b-form-input>
                <small style="font-size: 11px; color: red">
...
export default {
  ...
  watch: {
    selectedPeople: function () {
      this.visibleDivTipoPessoa =
        this.selectedPeople === "JURIDICA" ? true : false;
      this.texto =
  ...
  methods: {
    ...
    onSubmit() {
      const vm = this;
      this.$v.form.cnpj.$model =
        this.selectedPeople == "FISICA" ? "23.597.681/0001-12" : this.form.cnpj;
      this.$v.form.cpf.$model =
        this.selectedPeople == "JURIDICA" ? "048.376.259-83" : this.form.cpf;
      this.$v.form.apelido.$model =
        this.selectedPeople == "JURIDICA" ? "Apelido" : this.form.apelido;
      this.$v.form.nomefantasia.$model =
        this.selectedPeople == "FISICA"
          ? "nomeFantasia"
          : this.form.nomefantasia;
      if (this.$v.$invalid) {
        this.$v.$touch();
