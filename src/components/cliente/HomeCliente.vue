    ...
    <div class="container" style="margin-bottom: -90px;">
        <b-overlay :show="isLoading" rounded="sm">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <div class="">
                        <vue-good-table :columns="columns" :rows="clientes" @on-cell-click="selectCellCliente"
                            :search-options="{
                                    enabled: true,
            ...
            pageLabel: 'Pagina', // for 'pages' mode
                            ...
                            <template slot="table-row" slot-scope="props">
                                <span v-if="props.column.field === 'btn'">
                                    <a @click="showModalAlterarCliente(props.row.id)" size="sm" class="btn btn-sm me-1 mb-1"
                                        data-backdrop="static" title="EDITAR" style="background-color: #f0f8ff">
                                        <i class="bx bx-edit-alt"></i>
                                    </a>
                                    <a @click="showModalExcluirCliente(props.row.id)" size="sm" class="btn btn-sm me-1 mb-1"
                ...
                <div class="card-footer">
                    <div class="col-md-12 text-end">
                        <div class="col-md-2 offset-md-10">
                            <button class="btn btn-sm btn-dark" @click="ShowModalFormCliente()">
        ...
        <br /><br />
        <Modal :formulario="form_cliente" :functionGetListCliente="getListCliente" :funcOnReset="onReset"></Modal>
    </div>
</template>
<script>
