    ...
    <div class="container" style="margin-bottom: -90px;">
        <b-overlay :show="isLoading" rounded="sm">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <div>
                        <vue-good-table :columns="columns" :rows="produtos" @on-cell-click="selectCellProdutos"
                            :search-options="{
                                enabled: true,
    ...
    pageLabel: 'Pagina', // for 'pages' mode
                            ...
                            <template slot="table-row" slot-scope="props">
                                <span v-if="props.column.field === 'btn'">
                                    <a @click="showModalAlterarProduto(props.row.id)" size="sm" class="btn btn-sm me-1 mb-1"
                                        data-backdrop="static" title="EDITAR" style="background-color: #f0f8ff">
                                        <i class="bx bx-edit-alt"></i>
                                    </a>
                                    <a @click="showModalExcluirProduto(props.row.id)" size="sm" class="btn btn-sm me-1 mb-1"
                ...
                <div class="card-footer">
                    <div class="col-md-12 text-end">
                        <div class="col-md-2 offset-md-10">
                            <button class="btn btn-sm btn-dark" @click="ShowModalFormProduto()">
        ...
        <br /><br />
        <Modal :formulario="form_produto" :functionGetListProduto="getListProduto" :funcOnReset="onReset"></Modal>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        showModalAlterarProduto(id) {
            console.log(id);
            // this.onReset();
            // this.form_produto.titulo = "Alterar Categoria";
