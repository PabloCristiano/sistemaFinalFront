    ...
    <div class="container" style="margin-bottom: -90px;">
        <b-overlay :show="isLoading" rounded="sm">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <div class="">
                        <vue-good-table :columns="columns" :rows="paises" @on-cell-click="selectCell" :search-options="{
                                enabled: true,
            ...
            pageLabel: 'Pagina', // for 'pages' mode
                            ...
                            <template slot="table-row" slot-scope="props">
                                <span v-if="props.column.field === 'btn'">
                                    <a @click="showModalAlterar(props.row.id)" size="sm" class="btn btn-sm me-1 mb-1"
                                        data-backdrop="static" title="EDITAR" style="background-color: #f0f8ff;">
                                        <i class="bx bx-edit-alt"></i>
                                    </a>
                                    <a @click="showModalExcluir(props.row.id)" size="sm" class="btn btn-sm ms-1 mb-1"
        ...
        <br /><br />
        <b-modal :id="modal_form_pais" size="lg" :header-bg-variant="headerBgVariant"
            :header-text-variant="headerTextVariant" no-close-on-backdrop hide-footer>
            <template v-slot:modal-header>
                <h5>Cadastrar Pais</h5>
                <b-button style="border: 0" size="sm" variant="outline-light" @click="fechar()">
                    X
                </b-button>
            </template>
                ...
                <div>
                    <b-form @submit="onSubmit" @reset="onReset">
                        <div class="row col-12">
                            <div class="col-md-2">
                                <label>Código:</label>
                                <b-form-input id="id" v-model="form.id" type="text" placeholder="Id" disabled>
                                </b-form-input>
                            </div>
                            <div class="col-md-4">
                                <label>País:<b style="color: rgb(245, 153, 153)">*</b></label>
                                <b-form-input id="pais" v-model="form.pais" type="text" placeholder="Digite nome do país"
                                    :class="{ 'fail-error': $v.form.pais.$error }" required>
                                </b-form-input>
                            ...
                            <div class="col-md-3">
                                ...
                                <b-form-input id="sigla" v-model="form.sigla" type="text" placeholder="Sigla"
                                    :class="{ 'fail-error': $v.form.sigla.$error }" required>
                                </b-form-input>
                                <small style="font-size: 11px; color: red">{{
                            ...
                            <div class="col-md-3">
                                ...
                                <b-form-input type="text" id="ddi" v-model="form.ddi"
                                    :class="{ 'fail-error': $v.form.ddi.$error }" placeholder="+()" required>
                                </b-form-input>
                                <small style="font-size: 11px; color: red">{{
                        ...
                        <div class="d-flex justify-content-end">
                            <b-button class="btn btn-sm me-1" type="button" @click="fechar()" variant="dark">Cancelar
                            </b-button>
                            <b-button class="btn btn-sm ms-1" type="submit" variant="dark"
                                @click.prevent="onSubmit()">Salvar
                                <i class="bx bx-check"></i>
                            </b-button>
                        </div>
                    </b-form>
                    <div class="col-12">
                        <small class="col-6 me-1" style="font-size: 11px; margin: 2px">Data Criação:
                        </small>
                        <small class="col-6 me-1" style="font-size: 11px">Data Ultima-Alt:</small>
                    </div>
                </div>
            </b-card>
        </b-modal>
        <Modal :id="modal_form_pais_alterar" titulo="Alterar Pais">
            <template v-slot:conteudo>
                <b-form>
                    <div class="row col-12">
                        <div class="col-md-2">
                            <label>Código:</label>
                            <b-form-input id="id" type="text" placeholder="Id" :value="form.id" v-model="form.id" disabled>
                            </b-form-input>
                        </div>
                        <div class="col-md-4">
                            <label>País:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="pais" :value="form.pais" v-model="form.pais" type="text"
                                placeholder="Digite nome do país" :title="form.pais" @change="$v.form.pais.$touch()"
                                :class="{ 'fail-error': $v.form.pais.$error }" required>
                            </b-form-input>
                            <small style="font-size: 11px; color: red">{{
                                validationMsg($v.form.pais)
                        ...
                        <div class="col-md-3">
                            <label>Sigla:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="sigla" :value="form.sigla" v-model="form.sigla" type="text"
                        ...
                        <div class="col-md-3">
                            <label>DDI:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="ddi" :value="form.ddi" v-model="form.ddi" placeholder="DDI" required>
                            </b-form-input>
                            <small style="font-size: 11px; color: red">{{
                                validationMsg($v.form.ddi)
                            }}</small>
            ...
            <template v-slot:botao>
                <div class="d-flex justify-content-end">
                    <b-button class="btn btn-sm me-1" type="button" variant="dark" @click="fechar()">Cancelar
                    </b-button>
                    <b-button class="btn btn-sm ms-1" type="button" variant="dark" @click.prevent="alterarPais()">Alterar<i
                            class="bx bx-check"></i>
                    </b-button>
                </div>
            </template>
        ...
        <Modal :id="modal_form_pais_excluir" titulo="Excluir Pais">
            <template v-slot:conteudo>
                <b-form>
                    <div class="row col-12">
                        <div class="col-md-2">
                            <label>Código:</label>
                            <b-form-input id="id" type="text" placeholder="Id" :value="form.id" v-model="form.id"
                                :disabled="true">
                            </b-form-input>
                        </div>
                        <div class="col-md-6">
                            <label>País:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="pais" type="text" :value="form.pais" v-model="form.pais"
                                placeholder="Digite nome do país" disabled>
                            </b-form-input>
                        </div>
                        <div class="col-md-2">
                            <label>Sigla:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="sigla" type="text" :value="form.sigla" v-model="form.sigla"
                                placeholder="Sigla" disabled>
                            </b-form-input>
                        </div>
                        <div class="col-md-2">
                            <label>DDI:<b style="color: rgb(245, 153, 153)">*</b></label>
                            <b-form-input id="ddi" placeholder="DDI" :value="form.ddi" v-model="form.ddi" disabled>
                            </b-form-input>
                        </div>
                        <small class="mt-2" style="font-size: 12px">Campos com <b style="color: rgb(245, 153, 153)">*</b>
                            são
            ...
            <template v-slot:botao>
                <div class="d-flex justify-content-end">
                    ...
                    <b-button class="btn btn-sm me-1" type="button" variant="dark" @click.prevent="excluirPais()">Excluir<i
                            class="bx bx-check"></i>
                    </b-button>
